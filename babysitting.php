...
//create server and database connection constants
        ...
        define ("DB_NAME", "House-help");
            ...
            $sql = "SELECT COUNT(maid_id) FROM maids WHERE specialization='BabySitting'";
            ...
            $sql = "SELECT maid_id, firstname, lastname, age, expe, availability  FROM maids WHERE specialization='BabySitting' ORDER BY expe DESC $limit";
            $query = mysqli_query($con, $sql);
        ...
        <html>
            <head>
                ...
                <meta charset="UTF-8">
                    ...
                    <script type="text/javascript" src="babysitbook.js"></script>
            ...
            <body>
                ...
                <div class="wrapper">
                    ...
                    <div id="phase1">
                        <p>
                        Welcome Mr/Mss.<strong><?php echo $firstName; ?></strong>, Please look from the list the House-help(Baby Sitter) you will like to choose.
                        Thank You.
                        </p>
                    ...
                    <div id="phase3">
                           ...
                           Number of Baby/Babies:<input id="baby"  name="baby" placeholder="2 babies"><br>
                            <br />
                            <br />
                    ...
                    <div id="show_all_data">
                            ...
                            <table>
                                ...
                                <td> <span id="display_baby"></span></td> 
