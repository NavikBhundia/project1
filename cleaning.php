...
//create server and database connection constants
        ...
        define ("DB_NAME", "House-help");
            ...
            $sql = "SELECT COUNT(maid_id) FROM maids WHERE specialization='Cleaning'";
            ...
            $sql = "SELECT maid_id, firstname, lastname, age, expe, availability  FROM maids WHERE specialization='Cleaning' ORDER BY expe DESC $limit";
            $query = mysqli_query($con, $sql);
            // This shows the user what page they are on, and the total number of pages
            $textline1 = "Cleaners (<b>$rows</b>)";
        ...
        <html>
            ...
            <body>
                ...
                <div class="wrapper">
                    ...
                    <form id="multiphase" onsubmit="return false" action="cleaning.php" method="post">
        
    
                    <div id="phase1">
                        <p>
                        Welcome Mr/Mss.<strong><?php echo $firstName; ?></strong>, Please look from the list the House-help(Cleaner) you will like to choose.
                        Thank You.
                        </p>
                    ...
                    <div id="phase3">
                            ...
                            Number of People:<input id="people"  name="people" placeholder="5 people"><br>
                            <br />
                            <br />
        
                            Number of Rooms:<input id="rooms"  name="rooms" placeholder="5 rooms"><br>
                            <br />
                            <br />
