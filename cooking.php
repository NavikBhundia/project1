...
//create server and database connection constants
        ...
        define ("DB_NAME", "House-help");
            ...
            $sql = "SELECT COUNT(maid_id) FROM maids WHERE specialization='Cooking'";
            ...
            $sql = "SELECT maid_id, firstname, lastname, age, expe, availability  FROM maids WHERE specialization='Cooking' ORDER BY expe DESC $limit";
            $query = mysqli_query($con, $sql);
            // This shows the user what page they are on, and the total number of pages
            $textline1 = "Cooks (<b>$rows</b>)";
        ...
        <html>
                ...
                <script>
                  ...
                  $(document).ready(function() {
                    $("#start_date").datepicker({minDate: '+0d'});
                     ...
                     $(document).ready(function() {
                    $("#end_date").datepicker({minDate: '+0d'});
                    });
            ...
            <body>
                ...
                <div class="wrapper">
                    ...
                    <form id="multiphase" onsubmit="return false" action="cooking.php" method="post">
