...
//create server and database connection constants
        ...
        define ("DB_NAME", "House-help");
            ...
            $sql = "SELECT COUNT(maid_id) FROM maids WHERE specialization='General'";
            ...
            $sql = "SELECT maid_id, firstname, lastname, age, expe, availability  FROM maids WHERE specialization='General' ORDER BY expe DESC $limit";
            $query = mysqli_query($con, $sql);
            // This shows the user what page they are on, and the total number of pages
            $textline1 = "General (<b>$rows</b>)";
        ...
        <html>
            ...
            <body>
                ...
                <div class="wrapper">
                    ...
                    <form id="multiphase" onsubmit="return false" action="general.php" method="post">
        
    
                    <div id="phase1">
                        <p>
                        Welcome Mr/Mss.<strong><?php echo $firstName; ?></strong>, Please look from the list the House-help(General) you will like to choose.
                        Thank You.
                        </p>
                    ...
                    <div id="phase3">
                           ...
                           Number of People:<input id="people"  name="people" placeholder="5 people">
                            ...
                            <option value="1">One meal per day</option>
                            <option value="2">Two meals per day</option>
                            <option value="3">Three meals per day</option>
                            </select>
                            <br />
                            <br />
                    ...
                    <div id="show_all_data">
                            ...
                            <table>
                                ...
                                <td><span id="display_people"></span></td> 
                                <td><span id="display_meals"></span></td>
                                <td><span id="display_rooms"></span></td>
                                <td><span id="display_babys"></span></td>
